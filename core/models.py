...
class Product(models.Model):
    ...
    status = models.CharField(max_length=100, null=True, choices=PRODUCT_STATUS)
...
class Category(models.Model):
    ...
    status = models.CharField(choices=CATEGORY_STATUS, null=True, blank=True, max_length=100, default='approved')
...
class AD(models.Model):
    ...
    status = models.CharField(choices=ADS_STATUS, null=True, blank=True, max_length=100)
    photo = models.CharField(max_length=500, null=True, blank=True)
